...
import { ApiBearerAuth, ApiBadRequestResponse, ApiConflictResponse, ApiForbiddenResponse, ApiNotFoundResponse, ApiOperation, ApiUnauthorizedResponse } from '@nestjs/swagger';
...
export const UpdateStoreSwagger = () =>
    applyDecorators(
        ...
        ApiSuccessResponse(StoreResponseDto, { description: 'Cập nhật thành công' }),
