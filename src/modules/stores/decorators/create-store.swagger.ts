...
import { ApiBearerAuth, ApiBadRequestResponse, ApiConflictResponse, ApiForbiddenResponse, ApiOperation, ApiUnauthorizedResponse } from '@nestjs/swagger';
...
export const CreateStoreSwagger = () =>
    applyDecorators(
        ...
        ApiSuccessResponse(StoreResponseDto, { status: 201, description: 'Tạo cửa hàng thành công' }),
